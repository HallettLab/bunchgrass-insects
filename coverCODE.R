...
# make wide
coverwide <- covertotals%>%
  pivot_wider(
    names_from = Group, values_from = plotC)

# inverts
## write csv
write.csv(coverwide, "C:\\Users\\14842\\Documents\\Hallett Lab\\My project\\2021 data\\plantsinvertSEM.csv")

# hoppers
## remove non-grasses/legumes
grassleg = subset(coverwide, select = -c(7, 8, 11))
write.csv(grassleg, "C:\\Users\\14842\\Documents\\Hallett Lab\\My project\\2021 data\\plantshopperSEM.csv")
