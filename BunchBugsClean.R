...
## write csv
write.csv(BLnoF, "C:\\Users\\14842\\Documents\\Hallett Lab\\My project\\2021 data\\CoverBromusLupine_c.csv")
...
## reshape/clean data
trophic <- gather(insectsGuild, Guild, Count, predator...9:herbivore...88, factor_key = TRUE)
...
## reshape/clean data
data_long <- gather(guild, herbtype, Count, other.part:leaf.12, factor_key = TRUE)
